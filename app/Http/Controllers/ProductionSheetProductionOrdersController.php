...
class ProductionSheetProductionOrdersController extends BillableController
{
...
//                            ->with('paymentmethod')
        ...
        return view('production_sheet_production_orders.index', $this->modelVars() + compact('productionSheet', 'documents', 'sequenceList', 'templateList', 'statusList', 'items_per_page'));
    }
