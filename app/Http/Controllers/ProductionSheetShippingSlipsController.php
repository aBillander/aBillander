...
//                            ->with('paymentmethod')
    ...
    public function createInvoices( Request $request )
    {
        ...
        $params = $request->only('production_sheet_id', 'should_group', 'template_id', 'sequence_id', 'document_date', 'status');
...
//        3b.- Group Orders
            ...
            foreach ($addresses as $address_id) {
                ...
                foreach ($methods as $method_id) {
                    ...
                    foreach ($customers as $customer_id) {
                        ...
                        {
                            $shippingslip = $this->invoiceDocumentGroup( $documents_by_ws_by_addrr_by_meth_by_cust, $params + $extra_params);
                            ...
                            foreach ($ids as $id) {
                                ...
                                $shippingslip = $this->invoiceDocumentGroup( $docs, $params + $extra_params);
    ...
    /**
     * Create ONE Invoice after a collection of Shipping Slips.
     * All Shipping Slips **MUST** have the same Customer
     *
     */
    // Maybe this method should be a static method of CustomerShippingSlip
    public function invoiceDocumentGroup( $documents, $params )
    {
