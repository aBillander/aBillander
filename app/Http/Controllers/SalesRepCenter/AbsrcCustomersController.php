...
class AbsrcCustomersController extends Controller {
   ...
   public function __construct(SalesRep $salesrep, SalesRepUser $salesrep_user, Customer $customer, Address $address)
   {
...
//                        ->get();
        ...
        $customers = $customers->paginate( Configuration::get('ABSRC_ITEMS_PERPAGE') );
        ...
        return view('absrc.customers.index', compact('customers', 'customer_groupList'));
...
//                $rules['shipping_address_id'] = 'exists:addresses,id,addressable_type,\\App\\Customer|exists:addresses,id,addressable_id,'.intval($id);
             ...
             $this->validate($request, $rules);
                ...
                return redirect(route('absrc.customers.edit', $id) . $section)
...
//            return json_encode( $customers );
    ...
    public function getOrders($id, Request $request)
    {
        ...
        return view('absrc.customers._panel_orders_list', compact('customer_orders', 'items_per_page'));
    }
    ...
    public function getPriceRules($id, Request $request)
    {
        ...
        return view('absrc.customers._panel_pricerules_list', compact('id', 'customer_rules', 'items_per_page_pricerules'));
    }
...
*/
        ...
        return view('absrc.customers._modal_product_consumption', compact('customer', 'product', 'lines'));
    }
...
*/
        ...
        return view('absrc.customers._panel_recent_sales', compact('lines', 'customer', 'items_per_page_products'));
    }
