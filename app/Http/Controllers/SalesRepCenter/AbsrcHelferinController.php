...
use App\Http\Controllers\HelferinTraits\AbsrcHelferinProductConsumptionTrait;
use App\Http\Controllers\HelferinTraits\AbsrcHelferinSalesTrait;
...
class AbsrcHelferinController extends Controller
{
   
   use AbsrcHelferinSalesTrait;
   use AbsrcHelferinProductConsumptionTrait;
...
//        $this->middleware('auth:web');
    ...
    public function index()
    {
        ...
        foreach ($models as $model) {
            # code...
            $modelList[$model] = l($model, 'helferin');
        }

        $default_model = Configuration::get('RECENT_SALES_CLASS');

        return view('absrc.helferin.home', compact('modelList', 'default_model'));
    }
