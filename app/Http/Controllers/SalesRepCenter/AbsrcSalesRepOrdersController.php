...
class AbsrcSalesRepOrdersController extends Controller {


   protected $salesrep, $salesrep_user, $customerOrder, $customerOrderLine;

   public function __construct(SalesRep $salesrep, SalesRepUser $salesrep_user, CustomerOrder $customerOrder, CustomerOrderLine $customerOrderLine)
   {
...
//                            ->with('paymentmethod')
        ...
        return view('absrc.orders.index', compact('customer_orders'));
	}
