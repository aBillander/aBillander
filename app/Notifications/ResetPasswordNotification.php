...
//                    ->view('auth.passwords.customer_reset_email')
                    ->markdown('auth.passwords.reset_email')      // From: resources/views/auth/passwords (See: https://laravel.com/docs/5.5/passwords#resetting-views)
...
//                    ->from('info@example.com')
                    ...
                    ->action('Recuperar la Contraseña', route('password.reset', $this->token))
