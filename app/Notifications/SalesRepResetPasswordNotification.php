...
class SalesRepResetPasswordNotification extends Notification
{
    use Queueable;
...
//                    ->view('auth.passwords.customer_reset_email')
                    ->markdown('auth.passwords.salesrep_reset_email')      // From: resources/views/auth/passwords (See: https://laravel.com/docs/5.5/passwords#resetting-views)
...
//                    ->from('info@example.com')
                    ...
                    ->action('Recuperar la Contraseña', route('salesrep.password.reset', $this->token))
