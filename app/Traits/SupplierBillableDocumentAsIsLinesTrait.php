...
trait SupplierBillableDocumentAsIsLinesTrait
{
     ...
     * 
     */
    public function addSupplierProductAsIsLine( $product_id, $combination_id = null, $quantity = 1.0, $params = [] )
    {
        // Do the Mambo!
        $line_type = 'product';
...
//        }
        ...
        // $supplier_price = $product->getPriceByCustomer( $supplier, $quantity, $currency );
        ...
        $pricetaxPolicy = array_key_exists('prices_entered_with_tax', $params) 
                            ...
                            : $supplier_price->price_is_tax_inc;        // <= $document->supplier->currentPricesEnteredWithTax( $document->document_currency )
