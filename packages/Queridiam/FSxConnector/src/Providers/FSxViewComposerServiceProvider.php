...
class FSxViewComposerServiceProvider extends ServiceProvider {
	...
	public function boot() {
		// ee: https://scotch.io/tutorials/sharing-data-between-views-using-laravel-view-composers

		//
	}
	
	public function boot_dist()
	{
		//
