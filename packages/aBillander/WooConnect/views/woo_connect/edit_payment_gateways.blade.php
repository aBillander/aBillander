...
<div class="row">
	...
	<div class="form-group col-lg-6 col-md-6 col-sm-6">
	    ...
	    @endif
	    {{ $pgates['method_title'].' ['.$pgates['id'].']' }}</label></div>
	...
	<div class="form-group col-lg-6 col-md-6 col-sm-6 {{ $errors->has('dic.'.$dic[$pgates['id']]) ? 'has-error' : '' }}">
        {!! Form::select('dic['.$dic[$pgates['id']].']', array('0' => l('-- Please, select --', [], 'layouts')) + $pgatesList, $dic_val[$pgates['id']], array('class' => 'form-control')) !!}
