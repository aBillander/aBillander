...
/*
|--------------------------------------------------------------------------
| Supplier Documents Language Lines :: Quotations, Orders, Shipping Slips, Invoices
|--------------------------------------------------------------------------
|
| .
|
...
return [
	...
	*/
	...
	'Save line and apply Supplier Price List and/or Price Rules.' => 'Guardar la línea y aplicar la Tarifa del Proveedor y/o Reglas de Precio.',
	'Save line "as is", and WILL NOT apply Supplier Price List and/or Price Rules.' => 'Guardar la línea "tal cual". NO se aplicará la Tarifa del Proveedor ni Reglas de Precio.',
    ...
    // Lots
    'Lot Number(s)' => 'Número(s) de Lote',
    'Comma separated list, as in: lot1:quantity1,lot2:quantity2.<br />Lot Quantity is optional, but when present, a colon (:) must be used as separator.' => 'Lista separada por comas, como: lote1:cantidad1,lote2:cantidad2.<br />Indicar la Cantidad de cada Lote es opcional, pero cuando se escribe, debe usar dos puntos (:) como separador.',
    'Available Lots' => 'Lotes disponibles',
