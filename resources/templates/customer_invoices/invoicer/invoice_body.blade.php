...
<table class="order-details" width="100%" style="border: 1px #ccc solid">
	...
	<thead>
		...
		<tr>
			...
			<th class="description" width="49%" style="border: 1px #ccc solid">
				<span>Producto</span>
			</th>
...
@else
	@if ( optional($line->product)->ecotax )
		...
		@include('templates::customer_invoices.invoicer.line_rae')
...
@include('templates::customer_invoices.invoicer.totals')
...
@include('templates::customer_invoices.invoicer.payments')
