...
<h1 class="document-type-label"> ALBARAN PICKING</h1>
...
@php
// Filter
$lines = $document->documentlines->filter(function ($value, $key) {
...
@else
	@if ( 0 && optional($line->product)->ecotax )

		@include('templates::customer_shipping_slips.gmdis_picking.line_rae')
...
@endif
			...
			<td class="barcode">
				<span>
					<span class="item-name">{{ optional($line->product)->location }}</span>
				</span>
			</td>
...
{{--
@include('templates::customer_shipping_slips.gmdis_picking.totals')
--}}
