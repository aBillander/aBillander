...
@php
		$do_apply_ecotaxes = ($document->supplier->address->country_id == AbiContext::getContext()->company->address->country_id);
@endphp
...
@else
	@if ( optional($line->product)->ecotax && $do_apply_ecotaxes )
		...
		@include('templates::supplier_invoices.default.line_rae')
...
@include('templates::supplier_invoices.default.totals')
