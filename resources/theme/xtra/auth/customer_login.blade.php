...
@section('title') {{ l('Customer Center :: Login', [], 'layouts') }} @parent @endsection
...
<div xclass="page-header">
    <h3 style="color: #555;">
        <a href="https://www.laextranatural.es">La Extranatural</a> <span style="color: #cccccc;">::</span> Clientes Profesionales
    </h3>        
</div>
