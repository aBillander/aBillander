        ...
        <div class="col-md-12">
            <div class="page-header">
                <div class="pull-right">
                    ...
                    <button name="b_search_filter" id="b_search_filter" class="btn xbtn-sm btn-success" style="margin-right: 152px" type="button"
                            title="{{l('Filter', [], 'layouts')}}">
            ...
            <div name="search_filter" id="search_filter"
                 @if( Request::has('search_status') AND (Request::input('search_status')==1) ) style="display:block"
