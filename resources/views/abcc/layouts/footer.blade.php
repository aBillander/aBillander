    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 text-right">
                <a class="footer-logo" href="http://www.abillander.com/" target="new"><i class="fa fa-bolt"></i> <span>aBillander</span></a> &nbsp; {{l('Version', [], 'layouts')}} {{ AbiConfiguration::get('SW_VERSION') }} 
