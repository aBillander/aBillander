...
<table id="customer_orders" class="table table-hover">
    ...
    <tbody id="order_lines">
        ...
        <tr>
            ...
            <td class="text-right">{{ $order->customerorderlines_count }}</td>
            ...
            <td class="text-right">
                ...
                <a class="btn btn-sm btn-grey" href="{ { URL::to('customerorders/' . $order->id . '/pdf') }}" title="{{l('PDF Export', [], 'layouts')}}"><i class="fa fa-file-pdf-o"></i></a -->
