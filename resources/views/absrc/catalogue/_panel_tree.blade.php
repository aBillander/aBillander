    ...
    <tr class="child xwarning {{ $child->id == $category_id ? 'warning' : '' }}">
      ...
      <td class="text-right">
                ...
                @if ( $child->id == $category_id )
                  <a class="btn btn-sm btn-success" href="{{ route('absrc.catalogue', ['search_status' => 0, 'category_id' => $child->id]) }}" title="{{l('Show', [], 'layouts')}}"><i class="fa fa-eye"></i></a>
                @else
                  <a class="btn btn-sm btn-lightblue" href="{{ route('absrc.catalogue', ['search_status' => 0, 'category_id' => $child->id]) }}" title="{{l('Show', [], 'layouts')}}"><i class="fa fa-share-square-o"></i></a>
                @endif
                @endif
