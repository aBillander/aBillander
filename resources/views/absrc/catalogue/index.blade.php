...
{!! Form::model(Request::all(), array('route' => 'absrc.catalogue', 'method' => 'GET', 
...
{!! link_to_route('absrc.catalogue', l('Reset', [], 'layouts'), null, array('class' => 'btn btn-warning')) !!}
</div>
...
<div class="container-fluid">
   <div class="row">
      ...
      <div class="col-lg-9 col-md-9 col-sm-9">
          ...
          @include('absrc.catalogue._panel_products')
