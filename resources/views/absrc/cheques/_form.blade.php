...
<div class="form-group col-lg-2 col-md-2 col-sm-2 {{ $errors->has('amount') ? 'has-error' : '' }}">
    ...
    {!! $errors->first('amount', '<span class="help-block">:message</span>') !!}
         ...
         <div class="form-group col-lg-2 col-md-2 col-sm-2 {{ $errors->has('currency_id') ? 'has-error' : '' }}">
            ...
            {!! Form::select('currency_id', $currencyList, old('currency_id', AbiConfiguration::getInt('DEF_CURRENCY')), array('class' => 'form-control', 'id' => 'currency_id')) !!}
...
<div class="row">
	...
	{!! link_to_route('absrc.cheques.index', l('Cancel', [], 'layouts'), null, array('class' => 'btn btn-warning')) !!}
...
//            source : "{{ route('customers.ajax.nameLookup') }}",
            source : "{{ route('absrc.orders.ajax.customerLookup') }}",
            minLength : 1,
