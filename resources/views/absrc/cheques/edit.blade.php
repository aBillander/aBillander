...
@section('title') {{ l('Customer Cheques - Edit') }} @parent @endsection
	...
	<div class="col-md-10 col-md-offset-1" style="margin-top: 20px">
		<div class="panel panel-info">
			...
			<div class="panel-body">
				...
				{!! Form::model($cheque, array('method' => 'PATCH', 'route' => array('absrc.cheques.update', $cheque->id))) !!}
...
<div class="row">
	<div class=" hide  col-md-10 col-md-offset-1" style="margin-top: 20px">

					@ include('absrc.cheque_details.embed_index')
