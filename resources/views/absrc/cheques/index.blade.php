...
@section('title') {{ l('Customer Cheques') }} @parent @endsection
...
<div class="page-header">
    <div class="pull-right" style="padding-top: 4px;">
        ...
        <a href="{{ route('absrc.cheques.create') }}" class="btn btn-sm btn-success" 
            title="{{l('Add New Item', [], 'layouts')}}"><i class="fa fa-plus"></i> {{l('Add New', [], 'layouts')}}</a>

        <a href="{{ route('cheques.export', Request::all()) }}" class=" hide  btn btn-sm btn-grey" 
                title="{{l('Export', [], 'layouts')}}"><i class="fa fa-file-excel-o"></i> {{l('Export', [], 'layouts')}}</a>


        <button type="button" class=" hide  btn btn-sm btn-behance" 
    ...
    <div class="col-md-12 xcol-md-offset-3">
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                ...
                {!! Form::model(Request::all(), array('route' => 'absrc.cheques.index', 'method' => 'GET', 'id' => 'process')) !!}
...
{!! link_to_route('absrc.cheques.index', l('Reset', [], 'layouts'), null, array('class' => 'btn btn-warning')) !!}
</div>
...
<table id="cheques" class="table table-hover">
	...
	@foreach ($cheques as $cheque)
		<tr>
            ...
            <td><a class="" href="{{ URL::to('absrc/customers/' . $cheque->customer->id . '/edit') }}" 
...
--}}
                <a class="btn btn-sm btn-warning" href="{{ URL::to('absrc/cheques/' . $cheque->id . '/edit') }}" title="{{l('Edit', [], 'layouts')}}"><i class="fa fa-pencil"></i></a>
