...
<div id="panel_addressbook_detail">
    ...
    <div class="page-header">
        <div class="pull-right" style="padding-top: 4px;">
            <a href="{{ URL::to('absrc/customers/' . $customer->id . '/addresses/create') . '?back_route=' . urlencode('absrc/customers/' . $customer->id . '/edit#addressbook') }}" class="btn btn-sm btn-success" 
            ...
            <tr>
                ...
                <td class="text-left">
                    ...
                    <a class="btn btn-sm btn-danger delete-item" data-html="false" data-toggle="modal" 
                            href="{{ URL::to('absrc/customers/'.$customer->id.'/addresses/' . $addr->id . '?back_route=' . urlencode('absrc/customers/' . $customer->id . '/edit#addressbook') ) }}" 
                            data-content="{{l('You are going to delete a record. Are you sure?', [], 'layouts')}}" 
                            data-title="{{ l('Address Book') }} :: ({{$addr->id}}) {{ $addr->alias }} " 
                            onClick="return false;" title="{{l('Delete', [], 'layouts')}}"><i class="fa fa-trash-o"></i></a>
                      @endif
                    @else
                    <a class="btn btn-warning" href="{{ URL::to('absrc/customers/' . $customer->id. '/restore' ) }}"><i class="fa fa-reply"></i></a>
                    <a class="btn btn-danger" href="{{ URL::to('absrc/customers/' . $customer->id. '/delete' ) }}"><i class="fa fa-trash-o"></i></a>
                    @endif
                </td>
            </tr>
            @endforeach
