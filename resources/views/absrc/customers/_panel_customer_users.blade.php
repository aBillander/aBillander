...
@include('absrc.customers/_modal_customeruser_create')

@include('absrc.customers/_modal_customeruser_cart')
...
<script type="text/javascript">
   ...
   $(document).ready(function() {
    ...
    function getCustomerUsers(){
      ...
      $.ajax({
        url: '{{ route( 'absrc.customer.getusers', [$customer->id] ) }}',
        data: {
    ...
    function getCustomerUserData( id ){
      ...
      var url = "{{ route('absrc.customeruser.getuser', ':id') }}";
