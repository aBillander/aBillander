...
<div class="form-group col-lg-4 col-md-4 col-sm-4">
    {!! Form::label('name', l('Product Name')) !!}
                 <a href="javascript:void(0);" data-toggle="popover" data-placement="top" data-target="body" 
                                    data-content="{{ l('Search by Name or Reference.', 'customers') }}">
                        <i class="fa fa-question-circle abi-help"></i>
                 </a>
                 <a href="javascript:void(0);" data-toggle="popover" data-placement="top" data-target="body" 
                                    data-content="{{ l('Reset search: empty field plus press [return].', 'customers') }}">
...
<script type="text/javascript">
   ...
   $(document).ready(function() {
        ...
        $("#line_autoproduct_name").autocomplete({
            source : "{{ route('absrc.products.ajax.nameLookup') }}",
            minLength : 1,
...
//                $('#measure_unit_id').val(value.item.measure_unit_id);
		...
		function getCustomerProducts( page = 1 ){
           ...
           url = '{{ route( 'absrc.customer.recentsales', [$customer->id] ) }}?product_id=' + product_id + '&page=' + page;
