...
<div class="row">
    <div class="col-md-12">
        <div class="page-header">
            ...
            <h2><a href="{{ URL::to('absrc/customers') }}">{{ l('Customers') }}</a> <span style="color: #cccccc;">/</span> {{ l('New Customer') }}</h2>
        </div>
    </div>
</div> 
      ...
      <div class="col-lg-10 col-md-10 col-sm-9">
            <div class="panel panel-info" id="panel_generales">
               <div class="panel-heading">
                ...
                {!! Form::open(array('url' => 'absrc/customers', 'id' => 'create_customer', 'name' => 'create_customer', 'class' => 'form')) !!}

                    @include('absrc.customers._form_create')
