...
<div class="page-header">
    <div class="pull-right" style="padding-top: 4px;">
        <a href="{{ route('absrc.customers.create') }}" class="btn btn-sm btn-success" 
    ...
    <div class="col-md-12 xcol-md-offset-3">
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                ...
                {!! Form::model(Request::all(), array('route' => 'absrc.customers.index', 'method' => 'GET')) !!}
...
{!! link_to_route('absrc.customers.index', l('Reset', [], 'layouts'), null, array('class' => 'btn btn-warning')) !!}
</div>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-right button-pad">
                @if (  is_null($customer->deleted_at) || 1 )
...
--}}
                ...
                <a class="btn btn-sm btn-warning" href="{{ URL::to('absrc/customers/' . $customer->id . '/edit') }}" title="{{l('Edit', [], 'layouts')}}"><i class="fa fa-pencil"></i></a>
{{--
                <a class="btn btn-sm btn-danger delete-item" data-html="false" data-toggle="modal" 
                    href="{{ URL::to('absrc/customers/' . $customer->id ) }}" 
