...
@section('title') {{ l('Reports') }} @parent @endsection
...
@include('absrc.helferin.reports_sales')



@include('absrc.helferin.reports_consumption')
...
//            appendTo : "#modalProductionOrder",
        ...
        function getCustomerData( customer_id )
        {
            ...
            $.ajax({
                url: "{{ route('absrc.ajax.customerLookup') }}",
