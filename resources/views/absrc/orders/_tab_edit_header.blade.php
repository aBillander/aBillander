...
{!! Form::hidden('taxing_address_id', $document->taxingaddress->id, array('id' => 'taxing_address_id')) !!}
      ...
      <div class="row">
         ...
         <div class="form-group col-lg-2 col-md-2 col-sm-2 {{ $errors->has('sales_rep_id') ? 'has-error' : '' }}">
            ...
            {!! Form::select('sales_rep_id', $salesrepList, null, array('class' => 'form-control', 'id' => 'sales_rep_id')) !!}
...
@if ( AbiConfiguration::isTrue('ENABLE_FSOL_CONNECTOR') && $model_path=='customerorders' )
...
@if ( $document->lines->count() == 0 || 1 )
         <div class="form-group col-lg-2 col-md-2 col-sm-2 {{ $errors->has('currency_id') ? 'has-error' : '' }}" style="visibility:hidden">
            {{ l('Currency') }}
         ...
         <div class="form-group col-lg-2 col-md-2 col-sm-2 {{ $errors->has('currency_conversion_rate') ? 'has-error' : '' }}" style="visibility:hidden">
