			...
			<div class="col-md-12 top20">
				...
				@if ($cinvoice->lines->count()>0)  
					...
					<tbody>
						...
						@foreach ($cinvoice->lines as $line)
...
<!-- -->
	...
	<div class="row">
		<div class="col-md-12">
			...
			<a class="btn btn-success" href="{{ URL::to('absrc/customers/' . $cinvoice->customer_id) }}" target="_blank"><i class="fa fa-user"></i> {{l('Show Customer')}}</a>		
...
{!! Form::open(array('url' => 'customerinvoices/'.$cinvoice->id.'/email', 'id' => 'form_sendEmailCustomerInvoice', 'name' => 'form_sendEmailCustomerInvoice', 'class' => 'form')) !!}
               ...
               <div class="form-group">
                  ...
                  <?php $num = ($cinvoice->document_id > 0 ?
							$cinvoice->document_reference :
							l('DRAFT', [], 'layouts') ); ?>
                  {!! Form::text('email_subject', l('Your Document :num from :name', ['num' => $num, 'name' => $company->name_fiscal]), array('id' => 'email_subject', 'class' => 'form-control', 'autocomplete' => 'off')) !!}
               </div>
