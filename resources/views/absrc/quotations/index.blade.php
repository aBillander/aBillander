...
{{-- Search Stuff --}}
          ...
          @include('absrc.quotations.index_form_search')
...
@endif
            ...
            <td class="text-right button-pad">
                ...
                <a class="btn btn-sm btn-success" href="{ { URL::to('customer quotations/' . $document->id) } }" title="{{l('Show', [], 'layouts')}}"><i class="fa fa-eye"></i></a>               
                -->
@if ( 0 )
                ...
                <!-- a class="btn btn-sm btn-lightblue" href="{{ URL::to('customer quotations/' . $document->id . '/shippingslip') }}" title="{{l('Document', [], 'layouts')}}"><i class="fa fa-file-pdf-otruck"></i></a -->
...
{{-- --}}
        $("#autocustomer_name").autocomplete({
            ...
            minLength : 1,
//            appendTo : "#modalProductionQuotation",
