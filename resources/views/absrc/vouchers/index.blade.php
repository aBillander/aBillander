...
{!! link_to_route('absrc.vouchers.index', l('Reset', [], 'layouts'), null, array('class' => 'btn btn-warning')) !!}
</div>
      ...
      <td class="text-center">
        @if ($payment->auto_direct_debit) 
          @if ($payment->bankorder)
            <a class="btn btn-xs btn-grey" href="{{-- route('sepasp.directdebits.show', $payment->bankorder->id) --}}"><i class="fa fa-bank"></i>
