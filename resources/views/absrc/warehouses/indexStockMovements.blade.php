...
<div class="page-header">
    <div class="pull-right" style="padding-top: 4px;">
        <a href="{{ URL::to('stockmovements/create') }}" class=" hide  btn btn-sm btn-success" 
        ...
        <a href="{{ route('absrc.warehouse.stockmovements.export', [$warehouse->id] + Request::all()) }}" class=" hide  btn btn-sm btn-grey" 
                title="{{l('Export', [], 'layouts')}}"><i class="fa fa-file-excel-o"></i> {{l('Export', [], 'layouts')}}</a>

    </div>
    <h2>
        <a href="{ { URL::to('warehouses') } }" onClick="return false;">{{ l('Stock Movements') }}</a> <span style="color: #cccccc;">/</span> {{ $warehouse->address->alias }}
    </h2>        
</div>
    ...
    <div class="col-md-12 xcol-md-offset-3">
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                ...
                {!! Form::model(Request::all(), array('route' => ['absrc.warehouse.stockmovements', $warehouse->id], 'method' => 'GET')) !!}
...
{!! link_to_route('absrc.warehouse.stockmovements', l('Reset', [], 'layouts'), [$warehouse->id], array('class' => 'btn btn-warning')) !!}
</div>
...
@endif
	...
	@foreach ($stockmovements as $stockmovement)
      ...
      <td><a href="{{ URL::to('products/' . optional($stockmovement->product)->id . '/edit') }}#inventory" title="{{l('Go to', [], 'layouts')}}" target="_new">{{ $stockmovement->reference }}</a>
{{--
...
@if ( 0 && $route = $stockmovement->getStockmovementableDocumentRoute() )
