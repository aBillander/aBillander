...
@section('title') {{ l('Chart - Customer Vouchers') }} @parent @endsection
...
var charts = {
        ...
        ajaxGetPostMonthlyData: function () {
            var urlPath =  "{{ route( 'chart.customervouchers.monthly.data' ) }}";
            var request = $.ajax( {
                method: 'GET',
                url: urlPath
        } );
