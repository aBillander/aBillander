...
@section('title') {{ l('Chart - Supplier Vouchers') }} @parent @endsection
...
var charts = {
        ...
        ajaxGetPostMonthlyData: function () {
            var urlPath =  "{{ route( 'chart.suppliervouchers.monthly.data' ) }}";
            var request = $.ajax( {
                method: 'GET',
                url: urlPath
        } );
