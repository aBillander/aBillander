...
<div class="row">
      ...
      <div class="form-group col-lg-6 col-md-6 col-sm-6 {{ $errors->has('customer_id') ? 'has-error' : '' }}">
        ...
        <div class="form-control" style="background-color: #eeeeee; opacity: 1;">
            {{ $chequedetail->customer->name_regular }}
        </div>
      ...
      <div class="form-group col-lg-6 col-md-6 col-sm-6 {{ $errors->has('address_id') ? 'has-error' : '' }}">
        ...
        <div class="form-control" style="background-color: #eeeeee; opacity: 1;">
            [{{ $chequedetail->address->alias }}] {{ $chequedetail->address->name_commercial }}
        </div>
...
<div class="row">
	...
	{!! link_to_route('cheques.chequedetails.index', l('Cancel', [], 'layouts'), array($cheque->id), array('class' => 'btn btn-warning')) !!}
