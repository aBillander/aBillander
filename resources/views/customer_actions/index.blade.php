...
<div class="page-header">
    ...
    <div class="pull-right" style="padding-top: 4px;">
        ...
        <button  name="b_search_filter" id="b_search_filter" class="btn btn-sm btn-success  hidden " type="button" title="{{l('Filter Records', [], 'layouts')}}">
           <i class="fa fa-filter"></i>
           &nbsp; {{l('Filter', [], 'layouts')}}
        </button>

        <a href="{{ route('actiontypes.index') }}" class="btn btn-sm btn-navy" 
                style="margin-right: 22px;"><i class="fa fa-tags"></i> {{l('Action Types', 'actiontypes')}}</a>
{{--
    ...
    <div class="col-md-12 xcol-md-offset-3">
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                ...
                {!! Form::model(Request::all(), array('route' => ['customers.actions.dashboard'], 'method' => 'GET')) !!}
...
{!! link_to_route('customers.actions.dashboard', l('Reset', [], 'layouts'), [], array('class' => 'btn btn-warning')) !!}
</div>
...
<table id="actions" class="table table-hover">
        ...
        <thead>
            <tr>
                ...
                <th class="text-left">{{ l('Customer', 'actions') }}</th>
...
@endif
                ...
                <td>
@if($action->customer)
                    <a href="{{ URL::to('customers/' . $action->customer->id . '/edit') }}" title="{{l('Go to', [], 'layouts')}}" target="_blank">{{ $action->customer->name_regular ?: $action->customer->name_fiscal }}</a>
@else
                    -
@endif                </td>
                <td>
