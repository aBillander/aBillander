...
@section('title') {{ l('Customer Groups - Create') }} @parent @endsection
...
<div class="row">
    <div class="col-md-12">
        <div class="page-header">
            ...
            <h2><a href="{{ URL::to('customergroups') }}">{{ l('Customer Groups') }}</a> <span style="color: #cccccc;">/</span> {{ l('New Customer Group') }}</h2>
        </div>
    </div>
</div> 
      ...
      <div class="col-lg-10 col-md-10 col-sm-9">
            <div class="panel panel-info" id="panel_generales">
               <div class="panel-heading">
                ...
                {!! Form::open(array('route' => 'customergroups.store', 'id' => 'create_customergroup', 'name' => 'create_customergroup', 'class' => 'form')) !!}
