...
{{--
    <div id="div_customer_order_availability_details">
       <div class="table-responsive">

    <table id="order_lines_availability" class="table table-hover">
        <thead>
            <tr>
...
@endif
    ...
    <div id="div_customer_order_availability">
       <div class="table-responsive">

    <table id="order_availability" class="table table-hover">
        <thead>
            <tr>
