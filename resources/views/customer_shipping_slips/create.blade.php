...
@section('title') {{ l('Customer Shipping Slips - Create') }} @parent @stop
...
@endif
            ...
            <h2><a href="{{ URL::to($model_path) }}">{{ l('Customer Shipping Slips') }}</a> <span style="color: #cccccc;">/</span> {{ l('New Customer Shipping Slip') }}</h2>
        </div>
    </div>
</div> 
