...
@if( ($payment->payment_type_id == AbiConfiguration::getInt('DEF_CHEQUE_PAYMENT_TYPE')) && $payment->chequedetail )
    ...
    <div class="alert alert-dismissible alert-warning">
      ...
      <p>{{ l('This Voucher is associated with a Check') }}: <strong>{{ $payment->chequedetail->cheque->document_number }}</strong></p>
    </div>

    <a class="btn xbtn-xs btn-blue" href="{{ URL::to('cheques/' . $payment->chequedetail->cheque_id . '/edit' ) }}" title="{{l('Go to', [], 'layouts')}}" target="_blank"><i class="fa fa-money"></i> {{ l('Cheque') }}</a>
