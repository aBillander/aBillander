...
<div class="modal fade" id="deliveryroutesHelp" tabindex="-1" role="dialog" aria-labelledby="myLaraBillander" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header alert-info">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h3 class="modal-title" id="myLaraBillander">Rutas de Reparto</h3>
            </div>
            <div class="modal-body">


<h2>¿Qué es una <i>Ruta de Reparto</i>?</h2>
<p>Una <strong><i>Ruta de Reparto</i></strong> consta de una sucesión ordenada de destinos o paradas (direcciones postales) que deben recorrerse en el orden especificado.</p>



<h2>¿Qué es una <i>Hoja de Reparto</i>?</h2>
<p>Una <strong><i>Hoja de Reparto</i></strong> consta de las entregas a realizar en los destinos o paradas correspondientes a una determinada Ruta de Reparto, y en un día especificado. Es el Documento que se entrega al Transportista para hacer las entregas.</p>
