    ...
    <div class="row">
            ...
            <div class="panel panel-info">
              <div class="panel-heading" style="color: #ffffff; background-color: #772953; border-color: #772953;">
                <h3 class="panel-title"><i class="fa fa-cubes"></i> Punto de Pedido y Re-Aprovisionamiento</h3>
              </div>


{!! Form::open(array('route' => 'helferin.reports.reorder', 'id' => 'reorder_report_form', 'class' => 'form')) !!}
...
--}}
    <div class="form-group col-lg-2 col-md-2 col-sm-2">
        ...
        {!! Form::select('mrp_type', $product_mrptypeList, null, array('id' => 'mrp_type', 'class' => 'form-control')) !!}
    </div>
