...
{!! Form::open(array('route' => array('products.images.import.process'), 'files' => true)) !!}

<div class="panel panel-info" id="panel_import_products">
   <div class="panel-heading">
      <h3 class="panel-title">{{ l('Import Product Images') }}</h3>
   </div>
   <div class="panel-body">


          @include('imports._form_upload_product_images')   
