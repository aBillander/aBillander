...
@section('title') {{ l('Import - Categories') }} @parent @endsection
    ...
    <div class="col-md-12">
        <div class="page-header">
            <div class="pull-right">
                <a href="{{ URL::to('categories') }}" class="btn btn-default"><i class="fa fa-mail-reply"></i> {{ l('Back to Categories') }}</a>
            </div>
            <h2><a href="{{ URL::to('categories') }}">{{ l('Categories') }}</a> <span style="color: #cccccc;">/</span> {{ l('Import') }}</h2>
        </div>
    </div>
</div>
...
<div class="container-fluid">
   <div class="row">
      ...
      <div class="col-lg-8 col-md-8 col-sm-8">
          ...
          @include('imports._panel_categories')
