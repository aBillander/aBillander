        ...
        <div class="row">
            <div class="col-xs-7">
                <h3 style="margin-top: 0px;">Producto: [{{$product->reference}}] <strong>{{$product->name}}</strong></h3>
                <!-- h4 style="color: #dd4814;">Obrador Pani</h4 -->
                
                <strong>Fecha:</strong> {{ \Carbon\Carbon::now() }} <br>
...
<div class="panel panel-primary" id="panel_manufacturing_1">
   <div class="panel-heading">
      <h3 class="panel-title">BOM :: Lista de Materiales<span class="pull-right hide">Cantidad: {{ number_format( $product->bom->quantity, 2, '.', '' ) }}</span></h3>
   </div>
 ...
 @endphp           
            ...
            @include('product_boms.reports.bom._bom_level', ['product' => $product, 'qt' => 1, 'bom' => $bom, 'level' => 0, 'node_id' => $node_id, 'parent_node_id' => $parent_node_id])
