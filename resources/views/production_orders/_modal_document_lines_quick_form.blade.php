...
function quick_formSubmit()
{
           ...
           if ( count == 0 )
           {
            ...
            var url = "{{ route('productionorders.quickaddlines', [$document->id]) }}";
...
//                    $("[data-toggle=popover]").popover();
        ...
        function auto_product_row( selector = "#row_autoproduct_name" ) {
            ...
            $( selector ).autocomplete({
                source : "{{ route('productionorders.searchproduct') }}?customer_id="+$('#customer_id').val()+"&currency_id="+$('#currency_id').val(),
                minLength : 1,
