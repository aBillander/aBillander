            ...
            <div class="form-group">
               ...
               {!! $errors->first('shippingslip_delivery_date', '<span class="help-block">:message</span>') !!}
                  ...
                  <div class="panel-footer">
                        ...
                        <a class="btn btn-info" href="javascript:void(0);" title="{{l('Confirm', [], 'layouts')}}" onclick = "this.disabled=true;$('#form-select-documents').attr('action', '{{ route( 'productionsheetorder.create.shippingslips' )}}');$('#form-select-documents').submit();return false;"><i class="fa fa-truck"></i> {{l('Confirm', 'layouts')}}</a>
