...
<table id="stocksummary" class="table table-hover">
    ...
    <tbody>
        <tr>
            ...
            <td>{{ $product->as_quantityable($product->lines->sum('quantity')) }}</td>
...
@endif
            ...
            <div class="panel panel-success">
              ...
              <div class="panel-heading">
                <h3 class="panel-title">{{ l('Customer Orders') }}
               </h3>
              </div>
              <div class="panel-body">
...
@foreach( $product->lines as $line )
        <tr>
            <td>
                <a xclass="btn btn-sm btn-warning" href="{{ URL::to('customerorders/' . $line->document->id . '/edit') }}" title="{{l('Edit', [], 'layouts')}}" target="_blank">
