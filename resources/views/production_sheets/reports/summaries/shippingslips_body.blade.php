...
<table class="head container">
    ...
    <tr>
        ...
        <td class="shop-info">
            ...
            <div class="shop-name"><h3 style="font-weight: normal;color: #dd4814;"><strong>Resumen de Albaranes</strong></h3></div>
{{--
...
--}}
    ...
    <tr style="background-color: #f5f5f5;">
      ...
      <th class="text-center" colspan="2">{{l('Totales')}}</th>
      <th class="text-center">{{l('Notes', [], 'layouts')}}</th>
      <th>{{l('Shipping Method')}}</th>
    </tr>

  @foreach ($sheet->customershippingslips as $order)
    <tr>
      ...
      <td class="text-right"><strong>{{ $order->as_money_amount('total_tax_incl') }}</strong></td>
