         ...
         @foreach ($product->images as $img)
           <tr style="vertical-align:middle;">
              ...
              <a class="view-image" data-html="false" data-toggle="modal" 
                     href="{{ URL::to( \App\Models\Image::$products_path . $img->getImageFolder() . $img->id . '-large_default' . '.' . $img->extension ) }}"
                     ...
                     onClick="return false;" title="{{l('View Image')}}">
                      ...
                      <img src="{{ URL::to( \App\Models\Image::$products_path . $img->getImageFolder() . $img->id . '-small_default' . '.' . $img->extension ) . '?'. 'time='. time() }}" style="border: 1px solid #dddddd;">
              </a>
