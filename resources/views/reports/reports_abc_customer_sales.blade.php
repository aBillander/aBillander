...
--}}
    ...
    <div class="alert alert-dismissible alert-warning" style="display: none;" id="abc_customer_sales_help">
...
--}}
          <h4> Análisis ABC (del término "El principio de Pareto", también llamado regla 80/20) </h4>
            <p> Cuando se trata de la gestión de clientes, el análisis ABC normalmente segrega a los clientes en tres categorías según sus ingresos y las medidas de control requeridas: <strong> A es el 20% de los clientes con el 80% de los ingresos totales y, por lo tanto, requiere un control estricto; B es un 30% de clientes con un 15% de ingresos; mientras que "C" es el 50% de los clientes con un ingreso mínimo del 5% y, por lo tanto, se lo considera más liberal </strong>. </p> 
    </div>
               ...
               <div class="panel-footer text-right">
                  <button class="btn xbtn-sm btn-lightblue" type="button" onclick="$('#abc_customer_sales_help').toggle('slow'); return false;">
