      ...
      @if ($supplier->attachments->count())
         @foreach ($supplier->attachments as $attachment)
           <tr style="vertical-align:middle;">
               ...
               <td>
                      <a href="{{ route( 'suppliers.attachment.show', [$supplier->id, $attachment->id] ) }}" title="{{l('View Document', 'layouts')}}">
               ...
               <td class="text-right">
                        ...
                        href="{{ route( 'suppliers.attachment.destroy', [$supplier->id, $attachment->id] ) }}" 
