...
@section('scripts')    @parent
    ...
    <script type="text/javascript">
        ...
        @if ( ($cid = intval( old('customer_id') )) > 0 ) 
              ...
              var id = {{ $cid }};
              var url = "{{ route('warehouseshippingslips.ajax.customer.AdressBookLookup', [$cid]) }}";
...
//            source : "{{ route('customers.ajax.nameLookup') }}",
            source : "{{ route('warehouseshippingslips.ajax.customerLookup') }}",
            minLength : 1,
//            appendTo : "#modalProductionOrder",
        ...
        function getCustomerData( customer_id )
        {
            ...
            $.ajax({
                url: "{{ route('warehouseshippingslips.ajax.customerLookup') }}",
