   <script type="text/javascript">
        ...
        $(document).ready(function() {
          ...
          $(document).on('click', '.create-document-product', function(evnt) {
               ...
               var url = "{ { route('warehouseshippingslips.productform', ['create']) }}";
...
{{-- *************************************** --}}
     ...
     */
        ...
        function loadDocumentHeader() {
           ...
           var url = "{ { route('warehouseshippingslips.getheader', $document->id) }}";
        ...
        function loadDocumentlines() {
           ...
           var panel = $("#panel_warehouse_shipping_slip_lines");
           var url = "{{ route('warehouseshippingslips.getlines', $document->id) }}";
        ...
        function loadDocumentPayments() {
           ...
           var panel = $("#panel_warehouse_shipping_slip_payments");
           var url = "{ { route('warehouseshippingslips.getpayments', $document->id) }}";
        ...
        function updateDocumentTotal() {
           ...
           var url = "{ { route('warehouseshippingslips.updatetotal', $document->id) }}";
...
//                   console.log(response);
        ...
        function saveNewPositions() {
            ...
            $.ajax({
                url: "{{ route('warehouseshippingslips.sortlines') }}",
                headers : {'X-CSRF-TOKEN' : token},
                method: 'POST',
                dataType: 'json',
                data: {
        ...
        $("body").on('click', ".modal_document_line_productSubmit", function( event ) {
            ...
            if ( id == '' )
                url = "{ { route('warehouseshippingslips.storeline', [$document->id]) }}";
//            else
//                url = "{ { route('warehouseshippingslips.updateline', ['']) }}/"+id;
...
//                    $("[data-toggle=popover]").popover();
        ...
        function getProductData( product_id, combination_id ) {
            ...
            $.ajax({
                url: "{{ route('warehouseshippingslips.getproduct') }}",
                headers : {'X-CSRF-TOKEN' : token},
                method: 'GET',
                dataType: 'json',
                data: {
...
//                    price = parseFloat(response.unit_customer_price.display);
        ...
        function getProductPriceData( product_id, combination_id, customer_id ) {
            ...
            $.ajax({
                url: "{ { route('warehouseshippingslips.getproduct.prices') }}",
                headers : {'X-CSRF-TOKEN' : token},
                method: 'GET',
                dataType: 'html',
                data: {
