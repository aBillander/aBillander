...
@section('title') {{ l('Work Centers - Edit') }} @parent @endsection
...
<div class="row">
    <div class="col-md-12">
        <div class="page-header">
            ...
            <h2><a href="{{ URL::to('workcenters') }}">{{ l('Work Centers') }}</a> <span style="color: #cccccc;">/</span> {{ $workcenter->name }}</h2>
        </div>
    </div>
</div> 
      ...
      <div class="col-lg-10 col-md-10 col-sm-9">
            <div class="panel panel-info" id="panel_generales">
               <div class="panel-heading">
                ...
                {!! Form::model($workcenter, array('method' => 'PATCH', 'route' => array('workcenters.update', $workcenter->id))) !!}
