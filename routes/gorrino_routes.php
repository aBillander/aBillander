...
Route::get('migratethis', function()
{
	...
	Illuminate\Support\Facades\DB::statement("create table `down_payments` (`id` int unsigned not null auto_increment primary key, `reference` varchar(32) null, `name` varchar(64) not null, `amount` decimal(20, 6) not null default '0', `date_of_issue` date null, `due_date` date null, `payment_date` date null, `posted_at` date null, `currency_id` int unsigned not null, `currency_conversion_rate` decimal(20, 6) not null default '1', `status` varchar(32) not null default 'pending', `notes` text null, `payment_type_id` int null, `customer_id` int unsigned null, `supplier_id` int unsigned null, `bank_id` int unsigned null, `created_at` timestamp null, `updated_at` timestamp null) default character set utf8mb4 collate utf8mb4_unicode_ci;");
