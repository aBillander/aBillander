...
https://github.com/mogrady-professional/Company-CMS-Laravel-8
...
Método altenativo: cargar base de datos con fake data (incluyendo un usuario Admin e imagenes para los productos, etc.) y modificando manualmente el fichero .env (copiandolo desde .env_sample).
-----
<a name="item3"></a>
## Installation Guide:
...
* [Step 3: Serve](#step3)
* [Step 4: Run the Installer](#step4)
* [Step 5: Extras](#step5)
...
You may also install via <a target="_blank" href="https://github.com/ozdemirburak/laravel-8-simple-cms/archive/master.zip">zip</a>, extract 
to any of your folders you wish, and install dependencies after that.
